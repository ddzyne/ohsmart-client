...
// export function lookupLanguageString(obj: LanguageStrings | string, language: Language): string | undefined {
//   return typeof obj === 'string' ? obj : obj[language as Language];
// }